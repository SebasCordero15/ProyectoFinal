...
public class InformacioH extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("HOTEL ROOF");

        jLabel2.setFont(new java.awt.Font("Nirmala UI", 0, 18)); // NOI18N
        jLabel2.setText("@hotelRoofCR");

        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/llamada-telefonica (4).png"))); // NOI18N
        jLabel3.setText("Numero telefonico:2502-3658");
        ...
        jLabel7.setText("Ubicados en San Pedro , San Jose");

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/tik-tok.png"))); // NOI18N
        ...
        getAccessibleContext().setAccessibleName("Informacion");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InformacioH.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InformacioH().setVisible(true);
            }
        });
    }
